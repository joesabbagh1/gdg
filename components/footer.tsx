        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-6">
            <Link
              ...
              className="text-muted-foreground hover:text-[#000000] dark:hover:text-[#ffffff] transition-all duration-300 hover:scale-110"
              aria-label="X"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-[#0A66C2] transition-all duration-300 hover:scale-110"
              aria-label="LinkedIn"
            >
            ...
            <Link
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-[#181717] dark:hover:text-[#ffffff] transition-all duration-300 hover:scale-110"
              aria-label="GitHub"
            >
              <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
